...
FIWARE_DOCKER_COMPOSE_LOCATION="/home/pc-lrt-oaibox/PycharmProjects/benchmarkDT/twins_to_compare/scorpio"
...
docker compose up -d &
gnome-terminal -- bash -c "cd $FIWARE_DOCKER_COMPOSE_LOCATION && docker compose up -d"
